...
public class LeagueIpStatListener implements IpStatListener {
    @SuppressWarnings("unused")
    private static Logger log = LoggerFactory.getLogger(LeagueIpStatListener.class);
    public static final LeagueIpStatListener me = new LeagueIpStatListener();
    /**
     *
     */
    private LeagueIpStatListener() {
    }
    @Override
